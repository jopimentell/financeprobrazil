...
function loadUsers(): User[] {
  ...
  const defaultUsers: User[] = [
    ...
    { id: 'user-1', name: 'João Silva', email: 'joao@email.com', role: 'user', createdAt: '2026-02-15', lastLogin: '2026-03-05', status: 'active' },
    { id: 'user-2', name: 'Maria Santos', email: 'maria@email.com', role: 'user', createdAt: '2026-02-20', lastLogin: '2026-03-06', status: 'active' },
    { id: 'user-3', name: 'Pedro Costa', email: 'pedro@email.com', role: 'user', createdAt: '2026-03-01', lastLogin: '2026-03-04', status: 'inactive' },
  ];
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{
      user, users, isAdmin: user?.role === 'admin',
